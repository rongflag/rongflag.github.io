...
```java
    static void test1(){
        ...
        System.out.println(nowDay.get(WeekFields.ISO.weekOfYear())); //24 // 获取周
        System.out.println(nowDay.toEpochDay() - beforeDay.toEpochDay()); // 399
        System.out.println("======================");
		// 注意LocalDateTime 计算日差的时候回计算后面时分秒 
        LocalDateTime beforeTime = LocalDateTime.of(2020, 5, 12, 23, 52);
        LocalDateTime nowTime = LocalDateTime.of(2021, 6, 15, 12, 12);
        Duration between1 = Duration.between(beforeTime, nowTime);
        System.out.println(between1.toDays()); // 398  
        ...
        System.out.println("====");
        System.out.println(beforeDay.toEpochDay());
        System.out.println(nowDay.toEpochDay());
    }
```
